...
class AVWDCRNN(nn.Module):
    def __init__(self, config: AGCRNConfig):
        ...
        self.feature_dim = config.c_in
        self.hidden_dim = config.rnn_units
        self.embed_dim = config.embed_dim
        self.num_layers = config.num_layers
        self.cheb_k = config.cheb_order
...
class AGCRN(AbstractSTEncoder):
    def __init__(self, config: AGCRNConfig, gp_supports, scaler):
        super(AGCRN, self).__init__(config, gp_supports, scaler)
        self.num_nodes = config.num_nodes
        self.feature_dim = config.c_in
